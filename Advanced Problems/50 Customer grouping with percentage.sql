...
(SELECT COUNT(CustomerGroup) FROM CTE_CustomerGrouping) AS ABC,
cast(Count(CustomerGroup) as float)/ cast((SELECT COUNT(CustomerGroup) FROM CTE_CustomerGrouping) as float) as PercentageInGroup
